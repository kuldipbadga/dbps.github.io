<?php
    ...
    if(isset($_POST['next2']))
    {
        ...
        $q="INSERT INTO `student_add`(`add_id`, `Reg_id`, `village`, `pincode`, `district`, `depot`) VALUES ('','$id','$village','$pin','$dist','$depo')";
        $in=mysqli_query($con,$q);

        if($in){
            header('location:NewPass-ins.php');
        }
    }
?>
<!DOCTYPE html>
	...
	<div class="login box box--big">
		...
		<form action="" method="post">
			<div class="agile-field-txt">
				...
				<input type="text" name="village" placeholder="Enter name of village " required="" />
			</div>
			<div class="agile-field-txt">
				<label> Pincode</label>
				<input type="text" name="pin" placeholder="Enter pincode of village" required="" id="myInput" />
			</div>
            <div class="agile-field-txt">
				<label> District</label>
				<input type="text" name="dist" placeholder="Enter name of district " required="" id="myInput" />
			</div>
            <div class="agile-field-txt">
				<label> Depot(taluka)</label>
				<input type="text" name="depo" placeholder="Enter name of Depot" required="" id="myInput" />
			</div>
