<?php
	...
	$q1="select * from verifier where validity=0";
...
<center>
	...
	<article>
		<table align="center">
			<tr>
				<td colspan="7" class="h">Requested Institutes</td>
			</tr>
			<tr>
				<th>ID</th>
		...
		while($fetch=mysqli_fetch_array($sel))
		{
            ...
            $name=$fetch['name'];
				...
				<td><a href="show_insti1.php?id=<?php echo $id?>">show</a></td>
				</tr><?php
			}
